    ...
    <div className="flex items-start gap-3 rounded-lg px-3 py-2.5 hover:bg-[#1A1A1A] transition-colors">
      ...
      {event.htmlLink && (
        <a
          ...
          className="flex-shrink-0 text-gray-600 hover:text-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#f7d344]"
        >
          ...
          <>
            ...
            {allDeadlines.length > 8 && (
              <button
                ...
                className="w-full px-3 py-2 text-center text-xs text-[#f7d344] hover:text-yellow-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#f7d344]"
              >
                {expanded ? 'Show less' : `View ${allDeadlines.length - 8} more`}
              </button>
            )}
          </>
        )}
